...
function updatePhoto($pdo, $photo_id, $newFileName, $username, $description) {
    $query = "UPDATE photos SET photo_name = :photo_name, description = :description WHERE photo_id = :photo_id";
...
function updatePhotoDescription($pdo, $photo_id, $description) {
    $query = "UPDATE photos SET description = :description WHERE photo_id = :photo_id";
    $stmt = $pdo->prepare($query);
    return $stmt->execute([
        ':description' => $description,
        ':photo_id' => $photo_id
